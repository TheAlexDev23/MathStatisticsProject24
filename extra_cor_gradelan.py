...
grade_lan = sheet["What grade do you usually get in language related subjects?"]
...
plt.bar(res_x, res_y)
# plt.show()
plt.savefig("output/extra_cor_gradelan.png", bbox_inches="tight")
